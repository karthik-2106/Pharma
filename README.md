...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    <a class="navbar-brand" href="#">Meds PharmaCompany</a>
  ...
  <div class="container mt-5">
    <div class="row">
      <div class="col-md-8">
        <h1>Meds PharmaCompany</h1><br><br>
        <p >Meds Pharmaceuticals is a leading global biopharmaceutical company dedicated to discovering, developing, and delivering innovative medicines to improve the lives of patients worldwide. </p> <br><br>     
        <p>With a focus on research and development, ABC Pharmaceuticals is committed to addressing unmet medical needs and advancing healthcare through groundbreaking therapies and cutting-edge technology. </p>      
  ...
  <footer class="bg-dark text-white text-center py-4 mt-5">
    <p>&copy; 2024 Meds PharmaCompany. Developed by karthikeyan M(212223110020). All rights reserved.</p>
  </footer>
...
<body>
      ...
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item dropdown active">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdownAbout">
            <a class="dropdown-item" href="#vision">Generic Research</a>
            <a class="dropdown-item" href="#mission">New Drug Discovery</a>
            <a class="dropdown-item" href="#values">opportunities</a>
  ...
  <div class="container mt-5">
    <div class="row">
      <div class="col-md-12">
        <br><br><h1>About Meds PharmaCompany</h1>
        <div id="vision">
          <h2>Vision</h2>
...
<head>
  ...
  <style>
    body {
      background-image: url('tablets.jpg');
      background-size: cover;
      background-repeat: no-repeat;
    }
    footer{
  ...
  <div class="container mt-5">
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="card-deck">
          <div class="card">
            <img src="calci.webp" class="card-img-top" alt="Product 1">
            <div class="card-body">
              <h5 class="card-title">Product 1</h5>
              <p class="card-text">Order CALCIMAX 500 HEALTH SUPPLEMENT TABLETS (500 MG OF CALCIUM).</p>
              <a href="#" class="btn btn-primary">Buy Now</a>
            </div>
          </div>
          <div class="card">
            <img src="prime q10.jpg" class="card-img-top" alt="Product 2">
            <div class="card-body">
              <h5 class="card-title">Product 2</h5>
              <p class="card-text">Each capsule contains: Coenzyme Q-10 50 mg, Vitamin E 50 mg, Soya Lecithin 20 mg, Vitamin B6 10 mg</p>
              <a href="#" class="btn btn-primary">Buy Now</a>
            </div>
          </div>
          <div class="card">
            <img src="ortho.jpg" class="card-img-top" alt="Product 3">
            <div class="card-body">
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        ...
        <address>
          ...
          147,kora street,chennai,<br>
          India, 632007<br><br>
          <strong>Email:</strong><br>
          meds@pharmacompany.com<br><br>
